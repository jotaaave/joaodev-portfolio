...
export default function Habilities() {
    return (
        <div id="habilities" className="bg-(--secondary-color) w-full">
            <div className="flex flex-col items-center justify-center pt-20">
                <TitleAppear className="text-2xl text-(--label-one)">My</TitleAppear>
                <TitleAppear className="text-4xl text-(--label-one)">Habilities</TitleAppear>
